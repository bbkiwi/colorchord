...
//          s f r p r     p o  b p  m                      n  d i   t     o  e                       m  t v    f  p    s      t p   #  d                 u
	{32,3,0,6,2,3,    5,15,3,44,0,   2,2,96,  4,4,69,  45,1,100,255,  25,DEFAULT_NUM_LEDS,       0, 1,0,   0, 0,   0,     1,1,  0, DEFAULT_NUM_LEDS, 0, 0},
	{16,3,0,6,2,3,    5,14,3,80,76,  0,0,16,  0,0,16,  45,1,100,255,  55,DEFAULT_NUM_LEDS-2,     0, 1,8,   4, 255, 1,     0,0,  1, DEFAULT_NUM_LEDS, 0, 0},
	{16,3,0,5,2,3,    5,14,3,85,85,  4,4,16,  7,7,16,  82,1,255,255,  15,(DEFAULT_NUM_LEDS-1)/3, 2, 1,0,   1, 0,   2,     0,0,  2, DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,6,2,6,    5,21,3,42,44,  2,2,16,  4,4,16,  45,1,100,255,  10,DEFAULT_NUM_LEDS,       0, 1,254, 20,0,   0,     0,0,  3, DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,5,2,3,    5,14,3,85,85,  4,4,16,  6,6,16,  82,1,75, 255,  55,(DEFAULT_NUM_LEDS-1)/3, 2, 1,8,   1, 0,   1,     0,0,  4, DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,6,2,3,    5,14,3,42,44,  2,2,16,  4,4,16,  45,1,200,255,  0, DEFAULT_NUM_LEDS,       0, 1,0,   5, 1,   1,     1,0,  5, DEFAULT_NUM_LEDS, 0, 0},
	{16,3,0,6,2,3,    5,14,3,80,76,  0,0,16,  9,9,16,  45,1,100,255,  55,DEFAULT_NUM_LEDS-2,     0, 1,8,   1, 0,   1,     0,0,  6, DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,5,2,4,    0,37,3,42,44,  2,2,16,  4,4,16,  45,1,200,255,  15,DEFAULT_NUM_LEDS,       0, 1,255, 0, 0,   0,     0,0,  7, DEFAULT_NUM_LEDS, 0, 0},
	{16,3,0,6,2,3,    5,51,3,255,0,  3,3,16,  8,8,16,  45,1,100,255,  55,DEFAULT_NUM_LEDS-2,     0, 1,8,   0, 1,   1,     0,0,  8, DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,6,2,3,    5,14,3,42,44,  2,2,16,  4,4,16,  45,1,200,255,  15,DEFAULT_NUM_LEDS/2,     1, 1,0,   0, 0,   0,     0,0,  9, DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,6,2,3,    5,14,3,42,44,  2,2,16,  4,4,16,  45,1,200,255,  15,DEFAULT_NUM_LEDS/3,     2, 1,0,   0, 0,   0,     0,0,  10,DEFAULT_NUM_LEDS, 0, 0},
	{ 8,3,0,6,2,3,    5,14,3,42,44,  2,2,16,  4,4,16,  45,1,200,255,  15,DEFAULT_NUM_LEDS/4,     3, 1,0,   0, 0,   0,     0,0,  11,DEFAULT_NUM_LEDS, 0, 0},
	{32,3,0,6,2,3,    5,15,3,44,0,   2,2,96,  4,4,69,  45,1,100,255,  25,DEFAULT_NUM_LEDS,       0, 1,1,   0, 0,   0,     1,1,  12,DEFAULT_NUM_LEDS, 0, 0},
	{32,3,0,6,2,3,    5,15,3,44,0,   2,2,96,  4,4,69,  45,1,100,255,  25,DEFAULT_NUM_LEDS,       0, 1,8,   0, 0,   0,     1,1,  13,DEFAULT_NUM_LEDS, 0, 0},
	{32,3,0,6,2,3,    5,15,3,44,0,   2,2,96,  4,4,69,  45,1,100,255, 101,DEFAULT_NUM_LEDS/8,     0, 1,0,   1, 31,  1,     1,0,  14,DEFAULT_NUM_LEDS, 0, 0},
	{32,3,0,6,2,3,    5,15,3,44,0,   2,2,96,  4,4,69,  45,1,100,255, 102,DEFAULT_NUM_LEDS,       0, 1,0,   0, 0,   0,     1,1,  15,DEFAULT_NUM_LEDS, 0, 0}
	};
