...
//          s f r p   r     p o  b p  m                      n  d i   t     o  e                       m  t v    f  p    s      t p   #  d                 u
	...
	{32,1,0,6,DUP,3,    5,15,3,44,0,   2,2,96,  4,4,69,  45,1,100,255, 103,DEFAULT_NUM_LEDS/3,     0, 1,0,   1,65, 129,     1,0, 13, DEFAULT_NUM_LEDS, 0, 0},
...
//		for( i = 0; i < 512; i++ )
		for( i = 0; i < 128; i++ )
		{
//NOTE  if replace below with uint8_t samp = 127; to test why oscope causes interferance
